 ...
 * @author marij
 */
public class PredstaveForm extends javax.swing.JFrame {

    Nalog n;
    
    /**
     * Creates new form PredstaveForm
     */
    public PredstaveForm(Nalog n) {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Pozorište \"Gardoš\" - Predstave");
        ...
        jScrollPane1.setViewportView(tblPredstava);
        ...
        jLabel3.setText("Pretraga predstave:");
        ...
        jLabel7.setText("Naziv predstave:");
        ...
        btnSacuvaj.setText("Sacuvaj predstavu");
    ...
    private void btnDetaljiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetaljiActionPerformed
     int row = tblPredstava.getSelectedRow();

        if (row >= 0) {
            ModelTabelePredstava mtp = (ModelTabelePredstava) tblPredstava.getModel();
            Predstava p = mtp.vratiPredstavu(row);
//            DetaljiGledalac dg = new DetaljiGledalac(this, rootPaneCheckingEnabled, g);
//            dg.setVisible(true);
    ...
    private void btnSacuvajActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSacuvajActionPerformed
        ...
        try {
            ...
            Logger.getLogger(PredstaveForm.class.getName()).log(Level.SEVERE, null, ex);
        } catch (Exception ex) {
            Logger.getLogger(PredstaveForm.class.getName()).log(Level.SEVERE, null, ex);
        }
