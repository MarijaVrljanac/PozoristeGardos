 ...
 * @author marij
 */
public class ModelTabeleKarta extends AbstractTableModel{
    private ArrayList<Karta> lista;
    private String[] kolone = {"Nalog", "Predstava", "KartaID", "Red", "Kolona", "Cena"};
    private String parametar = "";

    public ModelTabeleKarta() {
        try {

            lista = new ArrayList<>();

        } catch (Exception ex) {
            Logger.getLogger(ModelTabeleKarta.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
